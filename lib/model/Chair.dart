...
class Chair{
  ...
  Chair(this.id ,this.image, this.title, this.author, this.subtitle, this.price,
      this.details);
}

List<Chair> chairList = [
   Chair('1','assets/images/chair1.png', 'Irul Chair', 'Seto', 'Egronomical for human curve',
  ...
  Chair('2','assets/images/chair2.png', 'Amazon Chair', 'Seto', 'Egronomical for human curve',
  ...
  Chair('3','assets/images/chair3.png', 'Corrigan Studio', 'WayFair', 'The Harun chair has a simple and clean look',
...
Chair('4','assets/images/chair4.png', 'Costway Armless', 'Target', ' Crafted from durable and sturdy rubber wood',
